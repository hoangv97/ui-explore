...
import { MINIMALISM_SAMPLE } from './samples/minimalism';
import { NEUMORPHISM_SAMPLE } from './samples/neumorphism';
import { GLASSMORPHISM_SAMPLE } from './samples/glassmorphism';
import { BRUTALISM_SAMPLE } from './samples/brutalism';
import { HYPERREALISM_SAMPLE } from './samples/hyperrealism';
import { VIBRANT_BLOCK_SAMPLE } from './samples/vibrantBlock';
import { DARK_MODE_SAMPLE } from './samples/darkMode';
import { ACCESSIBLE_SAMPLE } from './samples/accessible';
import { CLAYMORPHISM_SAMPLE } from './samples/claymorphism';
import { AURORA_SAMPLE } from './samples/aurora';
import { RETRO_FUTURISM_SAMPLE } from './samples/retroFuturism';
import { FLAT_DESIGN_SAMPLE } from './samples/flatDesign';
import { SKEUOMORPHISM_SAMPLE } from './samples/skeuomorphism';
import { LIQUID_GLASS_SAMPLE } from './samples/liquidGlass';
import { MOTION_DRIVEN_SAMPLE } from './samples/motionDriven';
import { MICRO_INTERACTIONS_SAMPLE } from './samples/microInteractions';
import { INCLUSIVE_DESIGN_SAMPLE } from './samples/inclusiveDesign';
import { ZERO_INTERFACE_SAMPLE } from './samples/zeroInterface';
import { SOFT_EVOLUTION_SAMPLE } from './samples/softEvolution';
import { HERO_CENTRIC_SAMPLE } from './samples/heroCentric';
import { CONVERSION_OPTIMIZED_SAMPLE } from './samples/conversionOptimized';
import { FEATURE_RICH_SAMPLE } from './samples/featureRich';
import { MINIMAL_DIRECT_SAMPLE } from './samples/minimalDirect';
import { SOCIAL_PROOF_SAMPLE } from './samples/socialProof';
import { INTERACTIVE_DEMO_SAMPLE } from './samples/interactiveDemo';
import { TRUST_AUTHORITY_SAMPLE } from './samples/trustAuthority';
import { STORYTELLING_SAMPLE } from './samples/storytelling';
import { DATA_DENSE_SAMPLE } from './samples/dataDense';
import { HEAT_MAP_SAMPLE } from './samples/heatMap';
import { EXECUTIVE_DASHBOARD_SAMPLE } from './samples/executiveDashboard';
import { REAL_TIME_MONITORING_SAMPLE } from './samples/realTimeMonitoring';
import { DRILL_DOWN_ANALYTICS_SAMPLE } from './samples/drillDownAnalytics';
import { COMPARATIVE_ANALYSIS_SAMPLE } from './samples/comparativeAnalysis';
import { PREDICTIVE_ANALYTICS_SAMPLE } from './samples/predictiveAnalytics';
import { USER_BEHAVIOR_SAMPLE } from './samples/userBehavior';
import { FINANCIAL_DASHBOARD_SAMPLE } from './samples/financialDashboard';
import { SALES_INTELLIGENCE_SAMPLE } from './samples/salesIntelligence';
import { NEUBRUTALISM_SAMPLE } from './samples/neubrutalism';
import { BENTO_GRID_SAMPLE } from './samples/bentoGrid';
import { Y2K_AESTHETIC_SAMPLE } from './samples/y2kAesthetic';
import { CYBERPUNK_SAMPLE } from './samples/cyberpunk';
import { ORGANIC_BIOPHILIC_SAMPLE } from './samples/organicBiophilic';
import { AI_NATIVE_SAMPLE } from './samples/aiNative';
import { MEMPHIS_DESIGN_SAMPLE } from './samples/memphisDesign';
import { VAPORWAVE_SAMPLE } from './samples/vaporwave';
import { DIMENSIONAL_LAYERING_SAMPLE } from './samples/dimensionalLayering';
import { EXAGGERATED_MINIMALISM_SAMPLE } from './samples/exaggeratedMinimalism';
import { KINETIC_TYPOGRAPHY_SAMPLE } from './samples/kineticTypography';
import { PARALLAX_STORYTELLING_SAMPLE } from './samples/parallaxStorytelling';
import { SWISS_MODERNISM_SAMPLE } from './samples/swissModernism';
import { SCI_FI_HUD_SAMPLE } from './samples/sciFiHud';
import { PIXEL_ART_SAMPLE } from './samples/pixelArt';
import { BENTO_GRIDS_NEW_SAMPLE } from './samples/bentoGridsNew';
import { NEUBRUTALISM_NEW_SAMPLE } from './samples/neubrutalismNew';
import { SPATIAL_UI_SAMPLE } from './samples/spatialUi';
import { E_INK_SAMPLE } from './samples/eInk';
import { GEN_Z_CHAOS_SAMPLE } from './samples/genZChaos';
import { BIOMIMETIC_SAMPLE } from './samples/biomimetic';
...
export const UI_STYLES: UIStyleData[] = [
  {
    "STT": 1,
  ...
  },
  {
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": GLASSMORPHISM_SAMPLE
  },
  {
    "STT": 4,
  ...
  },
  {
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "High",
    "sampleCode": HYPERREALISM_SAMPLE
  },
  {
    "STT": 6,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": VIBRANT_BLOCK_SAMPLE
  },
  {
    "STT": 7,
  ...
  },
  {
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": CLAYMORPHISM_SAMPLE
  },
  {
    "STT": 10,
  ...
  },
  {
    ...
    "Complexity": "Medium",
    "sampleCode": RETRO_FUTURISM_SAMPLE
  },
  {
    "STT": 12,
  ...
  },
  {
    ...
    "Complexity": "High",
    "sampleCode": SKEUOMORPHISM_SAMPLE
  },
  {
    "STT": 14,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "High",
    "sampleCode": LIQUID_GLASS_SAMPLE
  },
  {
    "STT": 15,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "High",
    "sampleCode": MOTION_DRIVEN_SAMPLE
  },
  {
    "STT": 16,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": MICRO_INTERACTIONS_SAMPLE
  },
  {
    "STT": 17,
    ...
    "Era/Origin": "Universal",
    "Complexity": "Low",
    "sampleCode": INCLUSIVE_DESIGN_SAMPLE
  },
  {
    "STT": 18,
    ...
    "Complexity": "Low",
    "sampleCode": ZERO_INTERFACE_SAMPLE
  },
  {
    "STT": 19,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": SOFT_EVOLUTION_SAMPLE
  },
  {
    "STT": 20,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": HERO_CENTRIC_SAMPLE
  },
  {
    "STT": 21,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": CONVERSION_OPTIMIZED_SAMPLE
  },
  {
    "STT": 22,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": FEATURE_RICH_SAMPLE
  },
  {
    "STT": 23,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": MINIMAL_DIRECT_SAMPLE
  },
  {
    "STT": 24,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": SOCIAL_PROOF_SAMPLE
  },
  {
    "STT": 25,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": INTERACTIVE_DEMO_SAMPLE
  },
  {
    "STT": 26,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": TRUST_AUTHORITY_SAMPLE
  },
  {
    "STT": 27,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": STORYTELLING_SAMPLE
  },
  {
    "STT": 28,
  ...
  },
  {
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": EXECUTIVE_DASHBOARD_SAMPLE
  },
  {
    "STT": 31,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": REAL_TIME_MONITORING_SAMPLE
  },
  {
    "STT": 32,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": DRILL_DOWN_ANALYTICS_SAMPLE
  },
  {
    "STT": 33,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": COMPARATIVE_ANALYSIS_SAMPLE
  },
  {
    "STT": 34,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": PREDICTIVE_ANALYTICS_SAMPLE
  },
  {
    "STT": 35,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": USER_BEHAVIOR_SAMPLE
  },
  {
    "STT": 36,
    ...
    "Era/Origin": "",
    "Complexity": "",
    "sampleCode": FINANCIAL_DASHBOARD_SAMPLE
  },
  {
    "STT": 37,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": SALES_INTELLIGENCE_SAMPLE
  },
  {
    "STT": 38,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Low",
    "sampleCode": NEUBRUTALISM_SAMPLE
  },
  {
    "STT": 39,
  ...
  },
  {
    ...
    "Complexity": "Medium",
    "sampleCode": Y2K_AESTHETIC_SAMPLE
  },
  {
    "STT": 41,
  ...
  },
  {
    ...
    "Complexity": "Low",
    "sampleCode": ORGANIC_BIOPHILIC_SAMPLE
  },
  {
    "STT": 43,
  ...
  },
  {
    ...
    "Complexity": "Medium",
    "sampleCode": MEMPHIS_DESIGN_SAMPLE
  },
  {
    "STT": 45,
  ...
  },
  {
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Medium",
    "sampleCode": DIMENSIONAL_LAYERING_SAMPLE
  },
  {
    "STT": 47,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "Low",
    "sampleCode": EXAGGERATED_MINIMALISM_SAMPLE
  },
  {
    "STT": 48,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "High",
    "sampleCode": KINETIC_TYPOGRAPHY_SAMPLE
  },
  {
    "STT": 49,
    ...
    "Era/Origin": "2020s Modern",
    "Complexity": "High",
    "sampleCode": PARALLAX_STORYTELLING_SAMPLE
  },
  {
    "STT": 50,
    ...
    "Complexity": "Low",
    "sampleCode": SWISS_MODERNISM_SAMPLE
  },
  {
    "STT": 51,
  ...
  },
  {
    ...
    "Complexity": "Low",
    "sampleCode": BENTO_GRIDS_NEW_SAMPLE
  },
  {
    "STT": 54,
    "Style Category": "Neubrutalism",
    ...
    "Complexity": "Low",
    "sampleCode": NEUBRUTALISM_NEW_SAMPLE
  },
  {
    "STT": 55,
